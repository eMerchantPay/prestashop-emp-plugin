...
{if $emerchantpay['confirmation']['status'] == 'success'}
    <p>
        ...
        <br /><br />{l s='For any questions or for further information, please contact our' mod='emerchantpay'} <a href="{$link->getPageLink('contact', true)|escape:'htmlall':'UTF-8'}" target="_blank">{l s='customer support' mod='emerchantpay'}</a>.
    </p>
