...
{if version_compare($emerchantpay['presta']['version'], '1.5', '>=') && version_compare($emerchantpay['presta']['version'], '1.6', '<') }
    <div class="row" class="payment-method-{$emerchantpay['name']['module']|escape:'htmlall':'UTF-8'}">
        {if ($emerchantpay['payment']['methods']['direct'] && $emerchantpay['ssl']['enabled'])}
            <div id="payment-method-{$emerchantpay['name']['module']|escape:'htmlall':'UTF-8'}-direct" class="payment_module">
                                ...
                                <div class="payment-direct">
                                    ...
                                    <div class="form-wrapper">
                                        <div class="form-group active">
                                            <form action="{$emerchantpay['payment']['urls']['direct']|escape:'htmlall':'UTF-8'}"
                                                ...
                                                <input class="form-control submit" type="submit"
                                                       name="submit{$emerchantpay['name']['module']|escape:'htmlall':'UTF-8'}Direct"
