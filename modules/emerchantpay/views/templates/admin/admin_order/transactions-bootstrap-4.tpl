                        ...
                        <div class="form-group amount-input">
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" data-toggle="{$emerchantpay['name']['module']|escape:'htmlall':'UTF-8'}-tooltip" data-placement="top" title="{$emerchantpay['transactions']['order']['currency']['iso_code']|escape:'htmlall':'UTF-8'}">{$emerchantpay['transactions']['order']['currency']['sign']|escape:'htmlall':'UTF-8'}</span>
                                </div>
