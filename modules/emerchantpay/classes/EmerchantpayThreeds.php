...
class EmerchantpayThreeds
{
     ...
     */
    const PRESTASHOP_DATETIME_FORMAT = 'Y-m-d H:i:s';
    ...
    /**
     * @var array $paidStatuses Order statuses where the order is already paid
     */
    ...
    public static function getReorderItemsIndicator($cart, $customer, $isGuest)
    {
        ...
        foreach ($products as $product) {
            if (array_search($product['id_product'], array_column($boughtProducts, 'product_id'))) {
