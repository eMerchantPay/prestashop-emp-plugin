    ...
    Card = (function() {
        ...
        function Card(el, opts) {
            ...
            if (this.options.updateContainer) {
                this.$updateContainer = $(this.options.updateContainer);
            }
            this.render();
            this.attachHandlers();
        ...
        Card.prototype.handlers = {
            setCardType: function($el, e, cardType) {
                ...
                if (this.$updateContainer) {
                    if (!this.$updateContainer.hasClass(cardType)) {
                        this.$updateContainer.removeClass('unknown');
                        this.$updateContainer.removeClass(this.cardTypes.join(' '));
                        this.$updateContainer.addClass(cardType);
                        return this.$updateContainer.toggleClass('identified', cardType !== 'unknown');
                    }
                }
            },
